...
public class BOJ14428 {
     ...
     * 수열과 쿼리 16
     * 세그먼트 트리 문제
     * 배열의 인덱스로 세그먼트 트리를 구성을 하는데 부모 노드를
     * 자식들의 인덱스로 실제 값을 비교해 더 작은 값을 부모 노드로 하게 한다.
     */
    ...
    private int updateQuery(int node, int left, int right, int idx) {
    ...
    private int search(int node, int start, int end, int left, int right) {
